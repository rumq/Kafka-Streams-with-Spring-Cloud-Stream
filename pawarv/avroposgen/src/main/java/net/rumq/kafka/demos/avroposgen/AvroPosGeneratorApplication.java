package net.rumq.kafka.demos.avroposgen;

import net.rumq.kafka.demos.avroposgen.services.KafkaProducerService;
import net.rumq.kafka.demos.avroposgen.services.datagenerator.InvoiceGenerator;
